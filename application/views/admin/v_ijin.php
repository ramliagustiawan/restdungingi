        ...
        <div class="box">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" href="<?php echo base_url() . 'adminkantor/ijin/add_ijin' ?>"><span class="fa fa-plus"></span> Post ijin</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
      ...
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url() . 'adminkantor/ijin/hapus_ijin' ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <p>Apakah Anda yakin mau menghapus Posting <b><?php echo $ijin_judul; ?></b> ?</p>
...
<?php elseif ($this->session->flashdata('msg') == 'success') : ?>
  <script type="text/javascript">
    $.toast({
      heading: 'Success',
      text: "ijin Berhasil disimpan ke database.",
      showHideTransition: 'slide',
      icon: 'success',
      hideAfter: false,
      position: 'bottom-right',
