...
<header class="main-header">
  ...
  <a href="#" class="logo">
    ...
    <span class="logo-mini">KCD</span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg">Dungingi</span>
  </a>
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-footer">
              <div class="pull-right">
                <a href="<?php echo base_url() . 'superadmin/login/logout' ?>" class="btn btn-default btn-flat">Sign out</a>
              </div>
            </li>
          </ul>
        </li>
