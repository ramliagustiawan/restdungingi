    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Add Visi Misi</li>
        </ol>
      </section>
      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Post Visi</h3>
          </div>

          <form action="<?php echo base_url() . 'superadmin/visi_misi/simpan_visi' ?>" method="post" enctype="multipart/form-data">
