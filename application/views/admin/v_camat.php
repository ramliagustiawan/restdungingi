...
<head>
  ...
  <title>Dungingi | Data Camat</title>
                  ...
                  <table id="example1" class="table table-striped" style="font-size:13px;">
                    ...
                    <tbody>
                      ...
                      foreach ($data->result_array() as $i) :
                        ...
                        $nip = $i['camat_nip'];
                        $nama = $i['camat_nama'];
                        $jenkel = $i['camat_jenkel'];
                        $periode = $i['camat_periode'];
  ...
  <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url() . 'superadmin/camat/simpan_camat' ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="inputUserName" class="col-sm-4 control-label">Periode</label>
              <div class="col-sm-7">
                <input type="text" name="xperiode" class="form-control" id="inputUserName" placeholder="Periode" required>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input type="text" name="xmapel" class="form-control" id="inputUserName" placeholder="Jabatan" required>
              </div>
            </div>
    ...
    <div class="modal fade" id="ModalEdit<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form class="form-horizontal" action="<?php echo base_url() . 'superadmin/camat/update_camat' ?>" method="post" enctype="multipart/form-data">
            <div class="modal-body">
              ...
              <div class="form-group">
                <label for="inputUserName" class="col-sm-4 control-label">Periode</label>
                <div class="col-sm-7">
                  <input type="text" name="xperiode" value="<?php echo $periode; ?>" class="form-control" id="inputUserName" placeholder="Periode" required>
                </div>
              </div>
    ...
    <div class="modal fade" id="ModalHapus<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
            <h4 class="modal-title" id="myModalLabel">Hapus camat</h4>
          </div>
          <form class="form-horizontal" action="<?php echo base_url() . 'superadmin/camat/hapus_camat' ?>" method="post" enctype="multipart/form-data">
            <div class="modal-body">
              <input type="hidden" name="kode" value="<?php echo $id; ?>" />
              <input type="hidden" value="<?php echo $photo; ?>" name="gambar">
              <p>Apakah Anda yakin mau menghapus ASN <b><?php echo $nama; ?></b> ?</p>
