      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Post Non Perijinan</h3>
          </div>

          <form action="<?php echo base_url() . 'adminkantor/nonijin/simpan_nonijin' ?>" method="post" enctype="multipart/form-data">

            <!-- /.box-header -->
            <div class="box-body">
              <div class="row">
                <div class="col-md-10">
                  <input type="text" name="xjudul" class="form-control" placeholder="Jenis Layanan" required />
                </div>
                <!-- /.col -->
                <div class="col-md-2">
          ...
          <div class="col-md-8">
            ...
            <div class="box box-danger">
              <div class="box-header">
                <h3 class="box-title">Non Perijinan</h3>
              </div>
              <div class="box-body">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="xket" class="form-control" id="keterangan" placeholder="Waktu / Biaya / Sumber" required>
