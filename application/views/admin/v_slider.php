                  ...
                  <table id="example1" class="table table-striped" style="font-size:13px;">
                    ...
                    <tbody>
                      ...
                      foreach ($data->result_array() as $i) :
                        ...
                        $slider_album_id = $i['slider_album_id'];
                        $slider_album_nama = $i['album_nama'];
                        $status = $i['active'];
                        ...
                        <tr>
                          ...
                          <td><?php echo $slider_album_nama; ?></td>
  ...
  <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url() . 'superadmin/slider/simpan_slider' ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input type="number" name="xstatus" class="form-control" id="inputUserName" placeholder="1 or 0" required>
              </div>
            </div>
    ...
    <div class="modal fade" id="ModalEdit<?php echo $slider_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form class="form-horizontal" action="<?php echo base_url() . 'superadmin/slider/update_slider' ?>" method="post" enctype="multipart/form-data">
            <div class="modal-body">
              ...
              <div class="form-group">
                <label for="inputUserName" class="col-sm-4 control-label">Status</label>
                <div class="col-sm-7">
                  <input type="text" name="xstatus" value="<?php echo $status; ?>" class="form-control" id="inputUserName" placeholder="1 or 0" required>
                </div>
              </div>
    ...
    <div class="modal fade" id="ModalHapus<?php echo $slider_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form class="form-horizontal" action="<?php echo base_url() . 'superadmin/slider/hapus_slider' ?>" method="post" enctype="multipart/form-data">
            <div class="modal-body">
              <input type="hidden" name="kode" value="<?php echo $slider_id; ?>" />
              <input type="hidden" value="<?php echo $slider_gambar; ?>" name="gambar">
