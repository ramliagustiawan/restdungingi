    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="#">Layanan Perijinan</a></li>
          <li class="active">Add Perijinan</li>
        </ol>
      </section>
      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Post Perijinan</h3>
          </div>

          <form action="<?php echo base_url() . 'adminkantor/ijin/simpan_ijin' ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" name="xtanggal" class="form-control" id="tanggal" required>
