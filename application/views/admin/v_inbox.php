...
<body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <tbody>
                      ...
                      foreach ($data->result_array() as $i) :
                        ...
                        <tr>
                          ...
                          <td><?php echo $inbox_tl; ?></td>

                          <td style="text-align:right;">
                            <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $inbox_id; ?>"><span class="fa fa-plus"></span></a>
  ...
  <?php foreach ($data->result_array() as $i) :
    ...
    <div class="modal fade" id="ModalEdit<?php echo $inbox_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
            <h4 class="modal-title" id="myModalLabel">Tindak Lanjut Pengaduan</h4>
          </div>
          <form class="form-horizontal" action="<?php echo base_url() . 'adminkantor/inbox/update_inbox' ?>" method="post" enctype="multipart/form-data">
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <input type="text" name="xtl" class="form-control" value="<?php echo $inbox_tl; ?>" id="inputUserName" placeholder="Keterangan" required>
                </div>
              </div>
    ...
    <div class="modal fade" id="ModalHapus<?php echo $inbox_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form class="form-horizontal" action="<?php echo base_url() . 'adminkantor/inbox/hapus_inbox' ?>" method="post" enctype="multipart/form-data">
            <div class="modal-body">
              <input type="hidden" name="kode" value="<?php echo $inbox_id; ?>" />
