<table border="1" class="table table-striped" id="display" style="font-size:12px;">
    <thead>
        <tr>
            <th rowspan="2">No</th>
...
<a href="<?php echo base_url() . 'penduduk/cetak/'
                . $bulan; ?>" target="blank" class="btn btn-danger"><span class="fa fa-file-pdf-o"></span> Print PDF</a>

<!-- tombol excel -->

<a href="<?php echo base_url() . 'penduduk/excel/'; ?>" target="blank" class="btn btn-success" style="margin-left: 1px;"><span class="fa fa-file-excel-o"></span> Export Excel</a>