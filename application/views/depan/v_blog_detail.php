                        ...
                        <div class="blog-share_block">
                            <div class="pull-left">
                                <div class="row">
                                    ...
                                    &nbsp;
                                    <a href="http://www.facebook.com/sharer.php?u=<?php echo site_url('artikel/' . $slug); ?>" target="_blank">
                                        <img style="height:24px; width:24px; " src="<?php echo base_url() . 'assets/images/fb.png' ?>" alt="Facebook" />
                                    </a>
                                    &nbsp;|&nbsp;
                                    <!-- Untuk Google+ -->
                                    <a href="https://plus.google.com/share?url=https://dungingi.site" target="_blank">
                                        <img style="height:24px; width:24px; " src="<?php echo base_url() . 'assets/images/google.png' ?>" alt="Google" />
                                    </a>
                                    &nbsp;|&nbsp;
                                    <!-- Untuk Twitter -->
                                    <a href="https://twitter.com/share?url=https://dungingi.site&text=Simple%20Share%20Buttons&hashtags=simplesharebuttons" target="_blank">
                                        <img style="height:24px; width:24px; " src="<?php echo base_url() . 'assets/images/twitter.png' ?>" alt="Twitter" />
                                    </a>
                                    &nbsp;|&nbsp;
                                    <a href="mailto:?Subject=Simple Share Buttons&Body=I%20saw%20this%20and%20thought%20of%20you!%20 https://dungingi.site">
                                        <img style="height:24px; width:24px; " src="<?php echo base_url() . 'assets/images/email.png' ?>" alt="Email" />
                                    </a>
                                </div>

                            </div>
                            <div class="sharePopup"><a href="#">
                                    <h6><i></i><span></span>
                                </a></h6>
                            </div>
                        </div>
